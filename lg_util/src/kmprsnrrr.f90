...
!     PURPOSE -                                                         
!                                                                       
!        Compress a vector x into vector y where z is not zero.                                                           
!                                                                       
!     INPUT ARGUMENTS -                                                 
!                                                                       
!        n   - (integer) the length of the input vector.
!        z   - (real) the mask vector.
!        iz  - (integer) the stride in z.
!        x   - (real) the source vector to be compressed.
!        ix  - (integer) the stride in x. 
!        iy  - (integer) the stride in y.                                                          
!                                                                       
!     OUTPUT ARGUMENTS -                                                
!                                                                       
!        y     - (real) the compressed output vector.
...
!
!PVCS    
!PVCS       Rev 1.2   03/16/95 08:03:06   ejl
