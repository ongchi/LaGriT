...
pset1 = mo.pset_geom(
    (0, 0, -1), (1100, 360, 10000), (1500, 1500, 0), "rtz", (1, 0, 0), "p_circle1"
)
pset2 = mo.pset_geom(
    (0, 0, -1), (1100, 360, 10000), (2500, 2500, 0), "rtz", (1, 0, 0), "p_circle2"
)
pset3 = mo.pset_geom(
    (0, 0, -1), (1100, 360, 10000), (2500, 1500, 0), "rtz", (1, 0, 0), "p_circle3"
)
...
mo.addatt(
    "id_top_region", vtype="vint", rank="scalar"
)  # Creat a node-based attribute id_top_region within the mesh object
...
r2_fm = mo.region(
    "gt " + str(sf1_fm) + " and " + "le " + str(sf2_fm) + " and " + "le " + str(sf_f)
)
r3_fm = mo.region("gt " + str(sf2_fm) + " and " + "le " + str(sf_f))
r1_fp = mo.region("le " + str(sf1_fp) + " and " + "gt " + str(sf_f))
r2_fp = mo.region(
    "gt " + str(sf1_fp) + " and " + "le " + str(sf2_fp) + " and " + "gt " + str(sf_f)
)
...
mowell1.createpts_rtz(
    (NRadius, 9, numZ), (0, 0, 3100), (Radius, 360, 1500)
)  # Create a cylindrical point cloud
