...
p.add_option(
    "--dem-file",
    help="DEM data file name including path",
    type="string",
    dest="dem_filename",
)
p.add_option(
    "--exo-file",
    help="Exodus II mesh output including path",
    type="string",
    dest="exo_filename",
)
p.add_option(
    "--dry-run",
    help="Show commands and diagnostics but no execution",
    default=False,
    dest="dry_run",
    action="store_true",
)
...
stack_hex.dump_ats_xml(
    xml_file_fullname, exo_file_fullname, matnames=matnames, facenames=facenames
)
